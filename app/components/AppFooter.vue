  ...
  <footer class="bg-white border-t border-gray-200 mt-16">
    <div class="max-w-6xl mx-auto px-4 py-10">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Top States</h3>
        ...
        <div>
          <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Calculators</h3>
          <ul class="space-y-1.5">
            <li v-for="calc in calcTypes" :key="calc.href">
              <NuxtLink :to="calc.href" class="text-sm text-gray-500 hover:text-gray-900 hover:underline">
                {{ calc.label }}
              </NuxtLink>
            </li>
          </ul>
        ...
        <div>
          <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">No Income Tax States</h3>
          <ul class="space-y-1.5">
        ...
        <div>
          <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">1099Freelancer</h3>
      ...
      <div class="border-t border-gray-100 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
        ...
        <nav class="flex gap-4">
          ...
          <NuxtLink to="/privacy" class="hover:text-gray-900">Privacy Policy</NuxtLink>
          <NuxtLink to="/terms" class="hover:text-gray-900">Terms of Service</NuxtLink>
        </nav>
      </div>
    </div>
  </footer>
