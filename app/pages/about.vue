  ...
  <main class="max-w-2xl mx-auto px-4 py-10">
    ...
    <div class="prose prose-gray max-w-none space-y-4 text-gray-600">
      <p>
        ...
        payments, and understand how business deductions reduce your tax bill.
      </p>
      <p>
        All calculators use 2026 IRS tax brackets and rates, updated each January. Calculations
...
useSeoMeta({
  title: 'About 1099Freelancer — Free Freelancer Tax Calculators',
  description: 'About 1099Freelancer: free tax calculators for freelancers and 1099 contractors. Updated for 2026 tax brackets.',
})
</script>
